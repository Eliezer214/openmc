...
_FILTER_TYPES = (
    ...
    'energyout', 'energyborn', 'mu', 'musurface', 'polar', 'azimuthal', 'distribcell', 'delayedgroup',
...
class EnergyBornFilter(RealFilter):
    """Bins tally events based on born particle energy.
